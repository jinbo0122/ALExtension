...
- (void)initializer
{
  ...
  SWCellScrollView *cellScrollView = [[SWCellScrollView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.bounds), ROW_HEIGHT)];
  ...
  UIView *scrollViewContentView = [[UIView alloc] initWithFrame:CGRectMake([self leftUtilityButtonsWidth], 0, CGRectGetWidth(self.bounds), ROW_HEIGHT)];
...
- (void)setContainingTableView:(UITableView *)containingTableView
{
  ...
  self.height = ROW_HEIGHT;//_containingTableView.rowHeight;
...
- (void)layoutSubviews
{
  ...
  self.cellScrollView.frame = CGRectMake(0, 0, CGRectGetWidth(self.bounds), ROW_HEIGHT);
  self.cellScrollView.contentSize = CGSizeMake(CGRectGetWidth(self.bounds) + [self utilityButtonsPadding], ROW_HEIGHT);
  self.cellScrollView.contentOffset = CGPointMake([self leftUtilityButtonsWidth], 0);
  self.scrollViewButtonViewLeft.frame = CGRectMake([self leftUtilityButtonsWidth], 0, 0, ROW_HEIGHT);
  self.scrollViewButtonViewLeft.layer.masksToBounds = YES;
  self.scrollViewButtonViewRight.frame = CGRectMake(CGRectGetWidth(self.bounds), 0, 0, ROW_HEIGHT);
  self.scrollViewButtonViewRight.layer.masksToBounds = YES;
  self.scrollViewContentView.frame = CGRectMake([self leftUtilityButtonsWidth], 0, CGRectGetWidth(self.bounds), ROW_HEIGHT);
...
- (void)setLeftUtilityButtons:(NSArray *)leftUtilityButtons
{
  ...
  [scrollViewButtonViewLeft setFrame:CGRectMake([self leftUtilityButtonsWidth], 0, [self leftUtilityButtonsWidth], ROW_HEIGHT)];
...
- (void)setRightUtilityButtons:(NSArray *)rightUtilityButtons
{
  ...
  [scrollViewButtonViewRight setFrame:CGRectMake(CGRectGetWidth(self.bounds), 0, [self rightUtilityButtonsWidth], ROW_HEIGHT)];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
  ...
  if (scrollView.contentOffset.x > [self leftUtilityButtonsWidth])
  {
    if ([self rightUtilityButtonsWidth] > 0)
    {
      ...
      self.scrollViewButtonViewRight.frame = CGRectMake(scrollView.contentOffset.x + (CGRectGetWidth(self.bounds) - scrollViewWidth), 0.0f, scrollViewWidth,ROW_HEIGHT);
  ...
  else
  {
    ...
    if ([self leftUtilityButtonsWidth] > 0)
    {
      ...
      self.scrollViewButtonViewLeft.frame = CGRectMake([self leftUtilityButtonsWidth], 0.0f, scrollViewWidth, ROW_HEIGHT);
    }
    else
    {
