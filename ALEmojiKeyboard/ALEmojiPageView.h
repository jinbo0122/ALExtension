...
//  Copyright (c) 2014 Albert Li. All rights reserved.
//

#import <UIKit/UIKit.h>

@protocol ALEmojiPageViewDelegate;

@interface ALEmojiPageView : UIView

@property (nonatomic, assign) id<ALEmojiPageViewDelegate> delegate;
