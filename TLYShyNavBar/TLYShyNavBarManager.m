...
- (void)_handleScrolling
{
    ...
    if (!isnan(self.previousYOffset))
    {
        ...
        //Custom Setting No use
        CGFloat lineViewY = self.navBarController.view.center.y+22;
        for (UIView *view in [self.viewController.navigationController.view subviews]) {
          if(view.tag == 1<<4){
            view.frame = CGRectMake(0, lineViewY, 320, 0.5);
          }
        }
    }
